import BaseDiscordEventEmitter, {
	type BaseDiscordEventArgs,
} from '#core/base/emitters/event/discord.js';
import { DiscordBotDBType } from '@packages/db';
import { type VoiceState } from 'discord.js';

export default class OnDisconnectGuildVoiceDiscordEvent extends BaseDiscordEventEmitter {
